        ...
        <>
            <nav className="flex items-center justify-center p-3  border-b-2 border-b-gray-300">
                ...
                <div className="top-navbar">
                    <button
                        className="lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start  flex flex-col lg:h-auto bg-blue-500 hover:bg-blue-600 hover:shadow-xl transition duration-150 rounded"
